...
class Dictionary(AdvancedMutableMapping):
	...
	def __setitem__(self, key, value):
		...
		key_object_path = self._key_storage.put(encoded_key)

		# Link the key to the translation
		os.link(key_object_path, key_path)
		...
		value_object_path = self._value_storage.put(encoded_value)

		# Link the value to the translation
		os.link(value_object_path, value_path)
	...
	def __delitem__(self, key):
		...
		self._key_storage.release(key_path)
		...
		self._value_storage.release(value_path)
